1. C14 isotope turns into N14 isotope by beta decay, how does this decay affect the proton number?
	- Increases by 1
2.  According to the following diagram, the granite pluton is older than the fault.
	- True
...
13. If the nucleus of an isotope captures five electrons, how would its proton number change?
	- Decrease by 5
14. According to the following diagram, the fault is older than the basalt dyke
	- True
